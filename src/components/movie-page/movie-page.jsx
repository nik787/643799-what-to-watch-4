        ...
        <div className="movie-card__wrap movie-card__translate-top">
          <div className="movie-card__info">
            <div className="movie-card__poster movie-card__poster--big">
              <img src={movieCard.posterImage} alt={movieCard.name} width="218" height="327" />
            </div>
            ...
            <div className="movie-card__desc">
              ...
              <div className="movie-rating">
                ...
                <p className="movie-rating__meta">
                  <span className="movie-rating__level">{ratingDescription(movieCard.rating)}</span>
                  <span className="movie-rating__count">{movieCard.scoresCount} ratings</span>
                </p>
              </div>
